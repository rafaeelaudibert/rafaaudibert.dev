...
> The JavaScript code runs directly in your browser. The graphics data were generated with a code written in C, compiled with GCC version $$5.1.0$$ which can be downloaded in [this](/assets/zip/sorting-2.zip) zip file containing the CSV data used as input.
