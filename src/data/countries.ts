...
export function countryCodeToFlag(countryCode: string): string {
  ...
  return `${LETTER_TO_REGIONAL_INDICATOR_EMOJI[countryCode[0]]}${
    LETTER_TO_REGIONAL_INDICATOR_EMOJI[countryCode[1]]
  }`
}
 ...
 */
export const COUNTRY_CODE_TO_LONG_NAME = {
  AD: "Andorra",
...
// Extracted from https://raw.githubusercontent.com/vasturiano/globe.gl/refs/heads/master/example/datasets/ne_110m_admin_0_countries.geojson
// Removed French Guiana from France for simplicity
// Added ISO_3 for some missing countries (France, Kosovo, Norway, Somaliland)
export const COUNTRIES_GEOMETRY = {
